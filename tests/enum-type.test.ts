...
describe("enumType schema helper", () => {
    test("accepts TypeScript string enums", async () => {
        ...
        const valid = await app.handle(new Request("http://localhost/roles", {
            method: "POST",
        ...
        const invalid = await app.handle(new Request("http://localhost/roles", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    test("accepts readonly enum arrays", async () => {
        ...
        const response = await app.handle(new Request("http://localhost/array-roles", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    test("accepts class constructors as schema definition", async () => {
        ...
        const valid = await app.handle(new Request("http://localhost/class-users", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
        ...
        const invalid = await app.handle(new Request("http://localhost/class-users", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    test("Schema helpers work alongside enum", async () => {
        ...
        const response = await app.handle(new Request("http://localhost/complex", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
